...
namespace test.UnitTests.DataLayer
{
    public class Ch02_CreateDbContext
    {
        ...
        {
            const string connection = "Server=localhost;Database=EfCoreInActionDb;User Id=sa;Password=!QAZ2wsx;";
            var optionsBuilder =
        ...
        {
            //SETUP
            const string connection = "Server=localhost;Database=EfCoreInActionDb;User Id=sa;Password=!QAZ2wsx;";               //#A
